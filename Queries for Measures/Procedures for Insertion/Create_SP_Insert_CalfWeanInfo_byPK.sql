DELIMITER //
DROP PROCEDURE IF EXISTS Insert_Calf_Wean_Info//
CREATE PROCEDURE Insert_Calf_Wean_Info(input_calf_id int,input_date_weighed date,input_wean_weight float,input_manage_code varchar(2),input_wean_status varchar(2),
				input_hip_height float(30),input_date_measured date,input_contemp_grp varchar(2),input_muscle_grade varchar(2),input_frame_score float,input_lot varchar(2),input_weaning_notes text)
BEGIN
